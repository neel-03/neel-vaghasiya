...
export const CustomButton = (props: ButtonHTMLAttributes<HTMLButtonElement>) => {
    return (
        <button
            data-cursor={true}
            {...props}
            className={`font-semibold whitespace-nowrap flex justify-center items-center px-3 pt-2 pb-1 border-2 rounded-md border-opacity-20 transition-colors shadow-md ${props.disabled ?
